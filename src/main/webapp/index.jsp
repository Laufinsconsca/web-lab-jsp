...
<jsp:useBean id="cutStringRequest" class="model.CutStringRequest" scope="session"/>
<jsp:setProperty name="cutStringRequest" property="*"/>
...
<body>
<div class="wrapper">
    <form class="form" action="result.html" id="indexForm" method="post">
        ...
        <label>
            <input type="number" id="cutLength" class="cutLength formEntry" name="cutLength"
